...
function classifyQuick(url) {
  try {
    ...
    const inMaliciousDataset = (self._PG_MALICIOUS_DATASET || ['phishy-demo.test','fraud-demo.test','secure-verify.test','purplehoodie.com','apunkagames.com','sadeempc.com','crackingpatching.com','oceanofgames.com','empresstorrents.com','blackboxrepacke.com']).some(d => matchesDomain(host, d));
